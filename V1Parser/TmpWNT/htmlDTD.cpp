...
boolean HtmlDTD::useVersion(char *versName)
{
...
void HtmlDTD::loadDefinitions(void)
{
    ...
    elementDef[tBase]->nbrAttributes= 1;
    elementDef[tBase]->attributes= new HtmlAttrDef("href", SgmlAttrDef::url, SgmlAttrDef::required);
...
boolean HtmlDTD::checkCategory(HtmlDTD::HtmlTags aTag, HtmlDTD::EntityCategory aCategory)
{
...
boolean HtmlDTD::isFromEntity(HtmlTags aTag, HtmlEntity anEntity)
{
    switch(anEntity) {
	case text:
