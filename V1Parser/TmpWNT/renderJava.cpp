...
char *JavaRenderer::elementClassName[HtmlDTD::numOfElements+6]= {
	...
	"HXmp"
	, "error"
	, "error", "error", "HComment", "HPcData", "HCdata"
};


JavaRenderer::JavaRenderer(ostream *output)
{
    outStream= output;
    nameStack= NULL;
    for (unsigned int i= 0; i < HtmlDTD::numOfElements+6; i++) usage[i]= 0;
